...
<body>
            ...
            <ul class="navbar-nav flex-row align-items-center">
              <li class="nav-item lh-1 me-3">
                <span class="faculty-welcome">
                  <i class="bx bx-user" style="font-size: 1.5rem;"></i> Welcome, <?php echo $faculty; ?>
                </span>
              </li>
            </ul>
            <!-- User -->
            <ul class="navbar-nav flex-row align-items-center ms-auto">
              <li class="nav-item navbar-dropdown dropdown-user dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                  ...
                  <li>
                    <a class="dropdown-item" href="../interval/interval_screen.php">
                            ...
                            <div class="card-body">
                                <h5 class="card-title d-flex justify-content-between">
                                    ...
                                    <table class="table" id="departmentTable">
                                        ...
                                        <tbody>
                                            <!-- Department list will be rendered here by JavaScript -->
                                        </tbody>
                                    </table>
                                </div>
                            </div>
                            ...
                            <div class="modal-content">
                                ...
                                <form id="addDepartmentForm">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="facultyName" name="facultyName" value="<?php echo $faculty; ?>" readonly>
                                    </div>
                                    <div class="mb-3">
    ...
    $(document).ready(function() {
        ...
        $('#addDepartmentForm').on('submit', function(e) {
            ...
            $.ajax({
                url: '../Database_users/add_department.php',
                type: 'POST',
                data: $(this).serialize(),
                beforeSend: function() {
    ...
    function fetchDepartmentList() {
        ...
        $.ajax({
            url: '../Database_users/show_departments.php',
            type: 'GET',
            success: function(response) {
                console.log('Department list fetched successfully');
                $('#departmentTable tbody').html(response);
            },
            error: function(xhr, status, error) {
    ...
    function deleteDepartment(departmentId) {
        if (confirm('Are you sure you want to delete this department?')) {
            ...
            $.ajax({
                url: '../Database_users/delete_department.php',
                type: 'POST',
