            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4">Select Class to Manage Time Table</h4>

                        <!-- Form Section -->
                        <div class="card">
                            <div class="card-body">
                                <form action="assing_time_table.php" method="GET">
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-12 text-center">
                                            <button type="submit" class="btn btn-primary">Go to Time Table Management</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
