            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4">Super Admin Management</h4>
                        <div class="card">
                            <div class="card-body">
...
<div class="modal fade" id="editAdminModal" tabindex="-1" aria-hidden="true">
    ...
    function fetchAdminList() {
        $.ajax({
            ...
            dataType: 'json',
            success: function(response) {
                let tableBody = $('#adminTable tbody');
                tableBody.html('');
                    ...
                    response.admins.forEach((admin, index) => {
                        tableBody.append(`
                            <tr>
                                ...
                                <td class="text-end">
                                    <button class="btn btn-sm btn-warning" onclick="editAdmin('${admin.username}')">Edit</button>
                    ...
                    tableBody.append(`
                        <tr>
                            <td colspan="3" class="text-center text-muted py-4">
                                <p class="mb-0">No admins found. Click "Add Admin" to create one.</p>
                            </td>
                        </tr>
                    `);
                }
