                            ...
                            <div class="card-body">
                                ...
                                <form method="GET" action="" class="d-flex flex-wrap align-items-end gap-3">
                                    ...
                                    <div>
                                        ...
                                        <a href="?class_name=<?php echo urlencode($class_name); ?>&department_name=<?php echo urlencode($department_name); ?>&study_mode=<?php echo urlencode($study_mode); ?>&subject_name=<?php echo urlencode($subject_name); ?>&semester=<?php echo urlencode($semester); ?>&academic=<?php echo urlencode($academic); ?>&faculty=<?php echo urlencode($faculty); ?>" class="btn filter-btn ms-2">
